...
uses
  Classes, SysUtils, contnrs, fpjson, rttiutils, jsonscanner, jsonparser, typinfo;
...
uses  dateutils, variants, rtlconsts, LazLoggerBase;
...
begin
  ...
  With TJSONParser.Create(JSON,[{joUTF8,}joComments,joIgnoreTrailingComma]) do
  {$ELSE}
